...
class Book extends Model
{
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['id', 'user_id', 'ebooktitle', 'subtitle', 'author', 'publisher', 'type', 'desc', 'ebook_logo', 'retailPrice', 'buyLink', 'pageCount', 'category', 'status', 'is_featured', 'book_ext', 'publisher_date', 'book_language', 'asin'];
