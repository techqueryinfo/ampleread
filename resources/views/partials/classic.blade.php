<div class="ample-book-slot-slider">
  <div class="ample-row">
    ...
    <div class="ample-book-view-all"> <i class="fa fa-arrow-right"></i>
      <div class="view-all"><a href="{{url('books/classics')}}" target="blank" style="text-decoration: none;">view all</a></div>
    </div>
  </div>
  <div class="owl-carousel owl-theme home-slider">@if(!$classics->isEmpty()) @foreach($classics as $book)
    @if($book->home_books)
