...
<div class="user-container">
    ...
    {!! Form::model($user, array('action' => array('ProfilesController@updateUserAccount', $user->id), 'method' => 'PUT', 'id' => 'user_basics_form', 'files' => true, 'enctype' =>"multipart/form-data")) !!} {!! csrf_field() !!}
            ...
            <div class="form-unit">
                ...
                <div class="content">
                    <select name="country_id" class="form-control" id="country">
                        ...
                        @if(isset($countries)) @foreach ($countries as $optionKey => $optionValue)
    ...
    {!! Form::close() !!} {!! Form::model($user, array('action' => array('ProfilesController@updateUserPassword', $user->id), 'method' => 'PUT', 'autocomplete' => 'new-password')) !!}
    <div class="user-password">
        <div class="form-group">
            <div class="form-unit form-group {{ $errors->has('password') ? ' has-error ' : '' }}">
                ...
                <div class="content">
                    {!! Form::password('password', array('id' => 'password', 'class' => 'form-control ', 'placeholder' => trans('forms.create_user_ph_password'), 'autocomplete' => 'new-password')) !!} @if ($errors->has('password'))
                    <span class="help-block">
            ...
            <div class="form-unit {{ $errors->has('password_confirmation') ? ' has-error ' : '' }}">
                ...
                <div class="content">
                    ...
                    <span id="pw_status"></span> @if ($errors->has('password_confirmation'))
                    <span class="help-block">
...
<div class="plan-listing">
    ...
    <div class="listing">
        ...
        <div class="foot">
          ...
          @else
          <input type="button" plan-id="{{$all_plan->id}}" charge-value="{{$all_plan->amount}}" class="first-btn" data-toggle="modal" data-target="#paymentModal" value="GET STARTED - ${{$all_plan->amount}}">@endif
        </div>
    </div>
    @endforeach @endif
</div>
