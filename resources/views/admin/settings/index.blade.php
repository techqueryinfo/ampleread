                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Site Tite</th><th>Site Meta Keywork</th><th>Site Meta Desc</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($settings as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->site_tite }}</td><td>{{ $item->site_meta_keywork }}</td><td>{{ $item->site_meta_desc }}</td>
                                        <td>
