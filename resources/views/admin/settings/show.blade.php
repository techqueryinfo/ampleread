                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Site Tite </th><td> {{ $setting->site_tite }} </td></tr><tr><th> Site Meta Keywork </th><td> {{ $setting->site_meta_keywork }} </td></tr><tr><th> Site Meta Desc </th><td> {{ $setting->site_meta_desc }} </td></tr>
                                </tbody>
                            </table>
                        </div>
