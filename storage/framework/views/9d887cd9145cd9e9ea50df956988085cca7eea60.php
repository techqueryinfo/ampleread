 <?php $__env->startSection('angularjs'); ?>
...
<form action="<?php echo e(url('/book/save')); ?>" method="POST" enctype="multipart/form-data"><?php echo e(csrf_field()); ?>
                ...
                <div class="row-four">
                    <div class="form-unit">
                        ...
                        <div class="content">
                            ...
                            <input type="hidden" name="book_id" value="<?php if(isset($book->id)): ?><?php echo e($book->id); ?><?php endif; ?>"/>
                            <input type="hidden" name="bookContentID" value="<?php if(isset($bookContent->id)): ?><?php echo e($bookContent->id); ?><?php endif; ?>"/>
                        </div>
                    </div>
                    <div class="form-unit">
            ...
            <div class="modal-body">
                <div class="ample-login-signup">
                    <div class="ample-login-section">
                        <form action="<?php echo e(url('/book/saveimage')); ?>" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('layouts.ebook-editor', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>