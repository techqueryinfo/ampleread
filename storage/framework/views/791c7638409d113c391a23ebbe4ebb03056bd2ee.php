...
<div class="ample-footer-right">
    <div class="footer-r1">
        <div class="heading">Company</div>
         <ul>
             <li><?php echo HTML::link(url('/about-us'), 'About us'); ?></li>
             <li><?php echo HTML::link(url('/contact-us'), 'Contact us'); ?></li>
             <li><?php echo HTML::link(url('/career'), 'Career'); ?></li>
             <li><?php echo HTML::link(url('/terms'), 'Terms'); ?></li>
             <li><?php echo HTML::link(url('/privacy'), 'Privacy'); ?></li>
         </ul>
    </div>
    <div class="footer-r1">
        ...
        <ul>
            ...
            <li><?php echo HTML::link(url('/subscription'), 'Subscription'); ?></li>
            <li><?php echo HTML::link(url('/help'), 'Help'); ?></li>
        </ul>
    </div>
    <div class="footer-r1">
