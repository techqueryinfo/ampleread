...
<div class="free-ebook">
	...
	<div class="ample-book-slot-slider">
		...
		<div class="owl-carousel owl-theme home-slider">
			<div class="item">
				<div class="image">
					<img src="/images/image10.jpg" alt="img1" />
				</div>
			...
			<div class="item">
				<div class="image">
					<img src="/images/image11.jpg" alt="img1" />
				</div>
				<div class="ample-button">
					<button>FREE</button>
				</div>
			...
			<div class="item">
				<div class="image">
					<img src="/images/image12.jpg" alt="img1" />
				</div>
				<div class="ample-button">
					<button>FREE</button>
				</div>
			...
			<div class="item">
				<div class="image">
					<img src="/images/image22.jpg" alt="img1" />
				</div>
				<div class="ample-button">
					<button>FREE</button>
				</div>
			...
			<div class="item">
				<div class="image">
					<img src="/images/image21.png" alt="img1" />
				</div>
				<div class="ample-button">
					<button>FREE</button>
				</div>
			...
			<div class="item">
				<div class="image">
					<img src="/images/image15.png" alt="img1" />
				</div>
				<div class="ample-button">
					<button>FREE</button>
				</div>
			...
			<div class="item">
				<div class="image">
					<img src="/images/image17.jpg" alt="img1" />
				</div>
				<div class="ample-button">
					<button>FREE</button>
				</div>
			...
			<div class="item">
				<div class="image">
					<img src="/images/image19.jpg" alt="img1" />
				</div>
				<div class="ample-button">
					<button>FREE</button>
				</div>
			...
			<div class="item">
				<div class="image">
					<img src="/images/image18.jpg" alt="img1" />
				</div>
				<div class="ample-button">
					<button>FREE</button>
				</div>
			...
			<div class="item">
				<div class="image">
					<img src="/images/image14.jpg" alt="img1" />
				</div>
				<div class="ample-button">
					<button>FREE</button>
				</div>
			...
			<div class="item">
				<div class="image">
					<img src="/images/image13.jpg" alt="img1" />
				</div>
				<div class="ample-button">
					<button>FREE</button>
				</div>
	...
	<div class="sign-in-review"> <i class="fas fa-lock"></i>
