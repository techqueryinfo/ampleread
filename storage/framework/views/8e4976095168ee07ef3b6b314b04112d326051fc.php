 <?php $__env->startSection('template_title'); ?> E-Book Detail Page <?php $__env->stopSection(); ?> <?php $__env->startSection('free-book-css'); ?>
<link rel="stylesheet" href="/css/free-book.css"> <?php $__env->stopSection(); ?> <?php $__env->startSection('content'); ?>
<div class="free-ebook">
    ...
    <div class="book-section">
        <div class="book">
            <?php if(substr($book->ebook_logo, 0, 4) == "http"): ?>
                <img src="<?php echo e($book->ebook_logo); ?>" alt="image1"/>
            <?php else: ?>
                <img src="/uploads/ebook_logo/<?php echo e($book->ebook_logo); ?>" alt="image1" />
            <?php endif; ?>
        </div>
        <div class="content">
            <div class="heading-book"><?php echo e($book->ebooktitle); ?></div>
            <div class="book-details">
                <span class="writer-name"><?php echo e($book->subtitle); ?></span><span class="year">, 2018</span>
            ...
            <div class="free-book">
                <div class="button">
                    <button type="submit" class="submit-button"><?php if($book->type == 'free'): ?> Read Book <?php else: ?> FROM $<?php echo e($book->retailPrice); ?> <?php endif; ?></button>
                </div>
            ...
            <div class="book-description"><?php echo e($book->desc); ?></div>
        </div>
    </div>
    ...
    <div class="ample-book-slot-slider">
        ...
        <div class="owl-carousel owl-theme home-slider">
            <?php $__currentLoopData = $related_book; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="item">
                <div class="image"><a href="<?php echo e(url('books/ebook/'.$val->id.'/'.$val->ebooktitle)); ?>">
                    <?php if(substr($val->ebook_logo, 0, 4) == "http"): ?>
                        <img src="<?php echo e($val->ebook_logo); ?>" alt="image1"/>
                    <?php else: ?>
                        <img src="/uploads/ebook_logo/<?php echo e($val->ebook_logo); ?>" alt="image1" />
                    <?php endif; ?>
                </a></div>
                <div class="ample-button">
                    <?php if($val->type == 'free'): ?>
                        <button>FREE</button>
                    <?php else: ?>
                        <button style="width: auto; background-color: #868686; border: #868686;">FROM $ <?php echo e($val->retailPrice); ?></button>
                    <?php endif; ?>
                </div>
                <div class="title"><?php echo e($val->ebooktitle); ?>: <?php echo e($val->subtitle); ?></div>
                <div class="writer"><?php echo e($val->subtitle); ?></div>
                <div class="star-container">
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
    ...
    <div class="sign-in-page-bar bar-extend"></div>
        <?php if(Auth::check() && empty($bookReview)): ?>
        <div class="rate-this-book">
         ...
         <div class="right-sec">
            <div class="heading">Rate this book</div>
            <form method="POST" enctype="multipart/form-data" action="<?php echo e(url('/book/review')); ?>" onsubmit="return validateForm()">
