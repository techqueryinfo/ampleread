...
Route::get('/abebooks/import/{keywork?}/{maxresults?}', 'API\ApiController@abebooks');
Route::get('/cjbooks/import/{keywork?}/{maxresults?}', 'API\ApiController@cjbooks');
...
Route::get('category', 'BookController@show_all_category');
